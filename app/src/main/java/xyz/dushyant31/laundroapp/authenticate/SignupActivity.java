...
import xyz.dushyant31.laundroapp.Deliveryapp.Pickup;
...
public class SignupActivity extends AppCompatActivity {
    ...
    private EditText inputEmail, inputPassword, Role, Company;
                        ...
                        .addOnCompleteListener(SignupActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    roleModel data = new roleModel(role,company);
                                    UIDModel userid = new UIDModel(user.getUid());
                                    mFirebaseDatabase.child(user.getUid()).setValue(data);

                                    if(role.equals("Cleaner")) {
                                        mFirebaseDatabase.child(company).setValue(userid);
                                        startActivity(new Intent(SignupActivity.this, Cleaner.class));
                                        finish();
                                    }
                                    if(role.equals("Driver")) {
                                        startActivity(new Intent(SignupActivity.this, PickDel.class));
                                        finish();
                                    }
                                    if(role.equals("Washer")) {
                                        startActivity(new Intent(SignupActivity.this, Washer.class));
                                        finish();
                                    }
                                    if(role.equals("Dryer")) {
                                        startActivity(new Intent(SignupActivity.this, Washer.class));
                                        finish();
                                    }
                                    if(role.equals("Folder")) {
                                        startActivity(new Intent(SignupActivity.this, Washer.class));
                                        finish();
                                    }
                                }
